...
// (app/api/leads/*, app/api/action/*) use the real per-user login session
// from lib/session.js instead. Prospects are Apex's own internal
// acquisition data — no tenant should ever see it — so it needs a
// *different* gate: "is this an authenticated Apex staff member," not
