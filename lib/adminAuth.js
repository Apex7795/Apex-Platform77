...
// (app/api/leads/*, app/api/action/*) are scoped to the single fixed
// PRIMARY_TENANT_ID this deployment serves (see app/api/leads/route.js) —
// there's no per-user tenant session, since this app currently serves one
// business. Prospects are Apex's own internal acquisition data — no
// tenant should ever see it — so it needs a *different* gate: "is this an
// authenticated Apex staff member," not "which tenant is this."
//
